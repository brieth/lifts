...
export const BODY_READINGS: BodyReading[] = [
  ...
  },
  {
    ...
    insight: {
      ...
      points: [
        'This one covers the training, not the run-up to it. All 42 logged sessions fall between these two scans, 62 days apart, which is a session every 1.5 days. The June reading closed two days before the first of them and measured the fragmented period that came before. This one measures the consistent phase from end to end.',
        ...
        'Nothing to change. Visceral fat held at 6, ECW/TBW at 0.370 is normal fluid balance, and SMI rose 8.5 to 8.7. The program is doing what it was built to do, on a cadence you are actually keeping. Take the next scan no sooner than two months out, since anything closer will not clear the noise floor.',
      ],
    },
  },
];
