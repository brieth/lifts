...
const MUSCLE: Record<string, MuscleGroup> = {
  ...
  'single-arm-high-cable-row': 'Back',
  'single-arm-mid-cable-row': 'Back',
  'single-arm-low-cable-row': 'Back',
...
const SECONDARY: Record<string, MuscleGroup[]> = {
  ...
  'single-arm-high-cable-row': ['Biceps', 'Delts'],
  'single-arm-mid-cable-row': ['Biceps', 'Delts'],
  'single-arm-low-cable-row': ['Biceps', 'Delts'],
