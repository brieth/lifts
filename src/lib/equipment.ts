...
const EQUIPMENT: Record<string, Equipment> = {
  ...
  'high-cable-crossover-fly': 'cable',
  'mid-cable-crossover-fly': 'cable',
  'low-cable-crossover-fly': 'cable',
  'single-arm-high-cable-row': 'cable',
  'single-arm-mid-cable-row': 'cable',
  'single-arm-low-cable-row': 'cable',
  ...
  'cable-rope-tricep-pushdown': 'cable',
  'underhand-cable-pushdown': 'cable',
